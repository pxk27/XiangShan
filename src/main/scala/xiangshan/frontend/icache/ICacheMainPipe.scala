...
//   }
  ...
  val s2_except     = VecInit(Seq(s2_except_tlb_pf(0) || s2_except_tlb_af(0) || s2_except_tlb_gpf(0), s2_double_line && (s2_except_tlb_gpf(1) || s2_except_tlb_pf(1) || s2_except_tlb_af(1))))
